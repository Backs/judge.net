...
namespace Judge.Tests.Application.ProblemsServiceTests
{
    ...
    internal sealed class GetProblemsListTests
    {
        ...
        public void FirstPageTest()
        {
            ...
            _taskRepository.Stub(o => o.GetTasks(new OpenedTasksSpecification(), page, pageSize)).Return(tasks);
        ...
        public void TotalPagesTest()
        {
            ...
            _taskRepository.Stub(o => o.GetTasks(new OpenedTasksSpecification(), 1, 2)).Return(tasks.Take(2));
            _taskRepository.Stub(o => o.Count(true)).Return(tasks.Length);
        ...
        public void SecondPageTest()
        {
            ...
            _taskRepository.Stub(o => o.GetTasks(new OpenedTasksSpecification(), 2, 2)).Return(tasks.Skip(2).Take(2));
            _taskRepository.Stub(o => o.Count(true)).Return(tasks.Length);
        ...
        public void SolvedProblemsTest()
        {
            ...
            _taskRepository.Stub(o => o.GetTasks(new OpenedTasksSpecification(), 1, 2)).Return(tasks);
            _taskRepository.Stub(o => o.Count(true)).Return(tasks.Length);
